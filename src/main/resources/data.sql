...
INSERT INTO supermarket.supermarket.order_status (order_status_id, order_status_name)
VALUES
    (1, 'PENDING'),
    (2, 'PAID'),
    (10, 'ARCHIVED');
...
/* Product categories */
INSERT INTO supermarket.supermarket.product_category (category_id, name)
VALUES
(1, 'Computers'),
(2, 'Cellphones'),
(3, 'Tablets'),
...
/* Sample products */
/* Laptops */
INSERT INTO supermarket.supermarket."product" (product_id, category_id, enabled, image_url, name, price)
